 ...
 */
class EventHandlingRule: AbstractJavaRule() {
    ...
    override fun visit(node: ASTClassOrInterfaceDeclaration, data: Any): Any? {
        ...
        if (!node.isNested) {
            ...
            addViolationWithMessage(data, node, "Please include some event handlers such as mousePressed and keyPressed in your submission.")
        } else {
